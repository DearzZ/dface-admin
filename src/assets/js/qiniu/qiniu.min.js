!function (e) {
      ...
      n("moxie/core/utils/Basic", [], function () {
        ...
        return {
          utf8_encode: e, utf8_decode: t, atob: function (e, i) {
            ...
            var n, r, o, s, a, u, l, c, d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", p = 0,
              f = 0, h = "", m = [];
            if (!e) return e;
            e += "";
            do {
        ...
        function t(e, t, i) {
          var n = 0, r = 0, o = 0,
            s = {dev: -6, alpha: -5, a: -5, beta: -4, b: -4, RC: -3, rc: -3, "#": -2, p: 1, pl: 1}, a = function (e) {
        ...
        function n() {
          ...
          t.extend(this, {
            append: function (r, o) {
              ...
              o instanceof i ? e = {name: r, value: o} : "array" === a ? (r += "[]", t.each(o, function (e) {
                s.append(r, e)
        ...
        function f() {
          ...
          var v, x, _, y, w, E, b, R, T = this, S = {
              ...
              responseText: null,
              response: null
            }, A = !0, I = {}, O = null, D = null, C = !1, N = !1, F = !1, L = !1, k = !1, M = !1, U = null, B = null,
            z = {}, P = "";
          e.extend(this, S, {
        ...
        function f() {
          ...
          s.call(this), e.extend(this, {
            ...
            embed: function (n, r) {
              ...
              var s, l = this,
                c = e.extend({width: this.width, height: this.height, type: this.type || "image/jpeg", quality: 90}, r);
              try {
        ...
        function a() {
          ...
          i.extend(this, {
            init: function (u) {
              ...
              var t = this.getRuntime(), i = t.getShim(), o = t.getShimContainer(), s = e && n.get(e.container),
          ...
          t.extend(this, {
            send: function (i, r) {
              ...
              try {
                switch (e) {
                  case"blob":
                    var n = new r(t.uid, p.response), o = p.getResponseHeader("Content-Disposition");
                    if (o) {
        ...
        function r(o) {
          function s(i, r) {
            var o, s, a, u, l, p, f, h, m = this, g = [], v = {}, x = {
              ...
              9: "SLONG",
              10: "SRATIONAL"
            }, _ = {BYTE: 1, UNDEFINED: 1, ASCII: 1, SHORT: 2, LONG: 4, RATIONAL: 8, SLONG: 4, SRATIONAL: 8};
        ...
        function c() {
          ...
          function h(e, i) {
            var n = Math.PI / 180, r = document.createElement("canvas"), o = r.getContext("2d"), s = e.width,
              a = e.height;
        ...
        function a() {
          ...
          i.extend(this, {
            init: function (t) {
              ...
              var e = this.getRuntime(), t = e.getShim(), i = e.getShimContainer(), o = u && n.get(u.container),
            ...
            send: function (d, p) {
              ...
              h.setAttribute("target", f + "_iframe"), p instanceof a && p.each(function (e, i) {
                if (e instanceof s) m && m.setAttribute("name", i); else {
                  ...
                  t.extend(n, {type: "hidden", name: i, value: e}), m ? h.insertBefore(n, m) : h.appendChild(n)
                }
                ...
                r.innerHTML = '<iframe id="' + f + '_iframe" name="' + f + '_iframe" src="javascript:&quot;&quot;" style="display:none"></iframe>', c = r.firstChild, i.appendChild(c), o.addEvent(c, "load", function () {
                  ...
                  try {
                    i = c.contentWindow.document || c.contentDocument || window.frames[c.id].document, /^4(0[0-9]|1[0-7]|2[2346])\s/.test(i.title) ? u = i.title.replace(/^(\d+).*$/, "$1") : (u = 200, l = t.trim(i.body.innerHTML), v.trigger({
                      ...
                      loaded: l.length,
                      total: l.length
                    }), g && v.trigger({type: "uploadprogress", loaded: g.size || 1025, total: g.size || 1025}))
                  } catch (t) {
  ...
  !function (global) {
    ...
    function QiniuJsSDK() {
      ...
      var qiniuUploadUrl;
      qiniuUploadUrl = "https:" === window.location.protocol ? "https://upload.qiniup.com" : "http://up.qiniup.com";
      ...
      this.resetUploadUrl = function (e) {
        ...
        var t, i, n, r, o, s, a, u, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", c = 0,
          d = 0, p = [];
        if (!e) return e;
        e += "";
        do {
        ...
        var t = function (e) {
          ...
          var n = t(i), r = window.location.protocol + "//api.qiniu.com/v2/query?ak=" + n.ak + "&bucket=" + n.bucket;
